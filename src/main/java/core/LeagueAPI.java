...
public class LeagueAPI {
    ...
    private static void checkGame(long gameID)  {
        try {
            ...
            if(!db.checkForGame(gameID))db.addGame(game.get("gameId").getAsLong(),playerArray,winningTeam,game.get("gameMode").getAsString(),game.get("queueId").getAsString(),true,game.get("gameVersion").getAsString(),championArray);
